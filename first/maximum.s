 ...
 #
 # %edi - Hold the index of data item being examined
 # %ebx - Largest data item found
 # %eax - Current data item
 #
 # The following memory locations are used:
 # data_items - Contains the item data.
 # 				0 is used to teminate the data
...
start_loop:				# start loop
 ...
 jle start_loop				# jump to loop beginning if the new one isn't biggest
...
loop_exit:
 ...
 # and it already has the maximum number
 		movl $1, %eax		# 1 the the exit() syscall
 		int $0x80
